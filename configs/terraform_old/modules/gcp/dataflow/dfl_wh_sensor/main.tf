resource "null_resource" "run_dataflow_job" {
    provisioner "local-exec" {
        ...
        python "${var.dfl_wh_sensor_script_path}/${var.dfl_wh_sensor_template}.py" \
            ...
            --template_location "gs://${var.bkt_mts_dataflow}/template/${var.dfl_wh_sensor_template}"
        EOT
    }
}
...
resource "google_dataflow_job" "dataflow_job" {
    ...
    template_gcs_path       = "gs://${var.bkt_mts_dataflow}/template/${var.dfl_wh_sensor_template}"
