...
def generate_fake_purchases(spark, df_customers, df_products, VAR_NUM_PURCHASES):
    """
        ...
        Returns:
            pyspark.sql.DataFrame: A DataFrame containing VAR_NUM_PURCHASES rows, each representing a fake purchase with customer and product information.

        Notes:
            - Each purchase is generated by randomly selecting a customer and a product.
    ...
    """
        ...
        Args:
            df_base (pyspark.sql.DataFrame): The base DataFrame containing at least the columns:
                'associate_id', 'card_id', 'address_id', 'product_id', 'inventory_id', 'location', and 'price'.
