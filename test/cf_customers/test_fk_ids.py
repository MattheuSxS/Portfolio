...
# ************************************************************************************************************************************ #
#                                       TEST TO ~~> src/cloud_function/cf_customers/utils/fk_ids.py                                    #
# ************************************************************************************************************************************ #
import re
import pytest
from datetime import date, timedelta, datetime
from src.cloud_function.cf_customers.utils.fk_ids import FakeDataPerson

@pytest.fixture
def generator():
    # Use default locale 'pt_BR' as in the implementation
